...
variable "vm_admin_ssh_key" {
  description = "Admin user to access in SSH to the virtual machine"
  type        = string
}
...
variable "os_offer" {
  description = "OS Offer of the Ubuntu"
  type        = string
}

variable "os_sku" {
  description = "OS Sku of the Ubuntu"
  type        = string
}

variable "os_version" {
  description = "OS Version of the Ubuntu"
  type        = string
}
